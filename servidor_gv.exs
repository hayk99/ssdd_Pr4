        ...
        estado = receive do
                                    ...
                                    nodo_emisor == estado_sistema.tentativa.primario ->
                                        ...
                                        estadoNuevo = cond do
                                            n_vista_latido == estado_sistema.tentativa.num_vista ->
                                                ...
                                                %{estado_sistema | vista: estado_sistema.tentativa, primario_latido: @latidos_fallidos+1}
                                            n_vista_latido == 0 ->
                    ...
                    :procesa_situacion_servidores ->
                        estado= if (length(estado_sistema.resto_nodos) > 0) do
                                resto_nodos =   for i <- resto_nodos, do: {elem(i,0), elem(i,1)-1}
                                end
        ...
        estado = if estado.tentativa.primario != :undefined do
                ...
                estadoNuevo = cond do
                    ...
                    true ->
                        ...
                        %{estado_sist | tentativa: %{estado_sist.tentativa | num_vista: (estado_sist.tentativa.num_vista + 1), copia: nodoNuevo},
                                     copia_latido: @latidos_fallidos+1,
